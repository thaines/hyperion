#ifndef EOS_INF_GAUSS_INTEGRATION_H
#define EOS_INF_GAUSS_INTEGRATION_H
//------------------------------------------------------------------------------
// Copyright 2007 Tom Haines

/// \file gauss_integration.h
...
class EOS_CLASS IntegrateBP
{
 public:
  /// &nbsp;
   IntegrateBP(nat32 width = 0,nat32 height = 0);
  ...
  /// &nbsp;
   static cstrconst TypeString() {return "eos::inf::IntegrateBP";}
 ...
 private:
  // Input...
   ...
   struct Pixel
   {
    ...
    struct
    {
     real32 m; // Multiplative component.
     real32 z; // Addative component.
     real32 ubM; // Unbiased version of m.
     real32 ubZ; // Unbiased version of z.
   ...
   ds::ArrayDel< ds::Array<Pixel> > in; // [y][x]. Declared like this so it it allocatable for large inputs.
